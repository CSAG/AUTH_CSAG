...
class IsString extends Base_1.Base {
    ...
    isDivisibleBy(number) {
        this.satisfies('isDivisibleBy', (value) => !Base_1.Base.hasValue(value) || validator.isDivisibleBy(value, number));
        return this;
    }
    notDivisibleBy(number) {
        this.satisfies('notDivisibleBy', (value) => !Base_1.Base.hasValue(value) || !validator.isDivisibleBy(value, number));
        return this;
    }
    // isEmail(options?)
    isEmail(options) {
